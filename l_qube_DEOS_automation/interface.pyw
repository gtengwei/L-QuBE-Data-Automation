...
def build():
    ...
    device_parameters =[
        ...
        [sg.Text(size=(12,1)), sg.Text('Slots', size=(8, 1), key='-SLOTS_text-'), sg.Multiline(key='-SLOTS-', tooltip='Slots to collate data from', enable_events=True, size=(30, 8), expand_x=True)],
    ]
